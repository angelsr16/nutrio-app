    ...
    <>
      <div className="proceedingRegister-form-grid">
        ...
        <div className="form-group g-grid">
          ...
          <textarea name="recomendaciones" type="text" onChange={handleChange} />
        </div>
      </div>
    </>
  );
